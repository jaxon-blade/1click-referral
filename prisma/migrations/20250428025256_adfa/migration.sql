...
CREATE TABLE "new_EmailTemplate" (
    ...
    "shop" TEXT NOT NULL,
    CONSTRAINT "EmailTemplate_shop_fkey" FOREIGN KEY ("shop") REFERENCES "Session" ("shop") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "new_ReferralsUsed" (
    ...
    "shop" TEXT NOT NULL,
    "orderId" TEXT,
    CONSTRAINT "ReferralsUsed_shop_fkey" FOREIGN KEY ("shop") REFERENCES "Session" ("shop") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "new_Rewards" (
    ...
    "shop" TEXT NOT NULL,
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "Rewards_shop_fkey" FOREIGN KEY ("shop") REFERENCES "Session" ("shop") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "new_SocialMediaSettings" (
    ...
    "shop" TEXT NOT NULL,
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "SocialMediaSettings_shop_fkey" FOREIGN KEY ("shop") REFERENCES "Session" ("shop") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "new_ThankYouWidgetSettings" (
    ...
    "shop" TEXT NOT NULL,
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "ThankYouWidgetSettings_shop_fkey" FOREIGN KEY ("shop") REFERENCES "Session" ("shop") ON DELETE CASCADE ON UPDATE CASCADE
);
